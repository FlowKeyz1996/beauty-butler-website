...
const BeautyButlerOffer: React.FC = () => {
  ...
  return (
    <section className="p-8 flex flex-col my-20 items-center bg-[#F7f7ff]">
      <h1 className="text-4xl font-bold text-center mb-4 font-apfelregular mt-10">
      ...
      <div className="flex flex-col md:flex-row justify-center items-start gap-8 w-full h-[100%]">
        ...
        <div className="text-left w-full md:max-w-[48%] bg-white p-6 shadow-lg rounded-lg flex flex-col justify-between flex-1 h-full">
        ...
        <div
          className="text-left w-full md:max-w-[48%] bg-[#8877D8] p-6 shadow-lg rounded-lg flex flex-col justify-between flex-1 h-full relative"
