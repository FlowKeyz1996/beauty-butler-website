...
const GettingStarted: React.FC = () => {
  return (
   ...
   <TagHeader text="How it works" maxWidth="max-w-[150px]" />
      ...
      {/* Header */}
      <h1 className="text-3xl md:text-5xl text-[#101828] mb-4 text-center md:leading-[rem] font-s font-apfelmittel">
      ...
      <div className="w-[95%] md:w-[90%]">
        {/* Top Card */}
        <div className="w-full mb-8 bg-[#f8f9fb] rounded-3xl border border-[#f2f4f7] flex flex-col-reverse md:flex-row p-4 md:p-6 md:justify-between">
          <div className="w-full flex flex-col relative items-center md:items-start mb-4 md:mb-0 md:w-1/2">
            {/* Left Div */}
            <h2 className="text-sm md:text-3xl font-apfelregular text-[#1d2939] mb-2 text-center md:text-left">
              Download Beauty Butler: find the best beauty and wellness experts for you.
            </h2>
            <img
              src="/01.svg"
              alt="Left Image"
              className="w-[80%] md:w-[50%] h-auto object-contain absolute -bottom-6"
            />
          </div>
          <div className="w-full flex justify-center md:w-1/2 border border-[#f2f4f7]">
            ...
            <img
              src="/Device.svg"
              alt="Right Image"
              className="w-[70%] md:w-[59%] h-auto object-contain rounded-lg relative top-7"
            />
          </div>
        </div>
        ...
        <div className="w-full flex flex-col md:flex-row space-y-4 md:space-y-0 gap-10">
          <div className="w-full md:w-1/2 bg-[#f8f9fb] rounded-3xl relative p-4 md:p-6 flex flex-col items-center border-[#f2f4f7]">
            {/* Text Above Images */}
            <h2 className="text-sm md:text-3xl mb-2 font-apfelregular text-[#1d2939] text-center md:text-left">
              Explore our extensive marketplace listings and categories.
            </h2>
            <div className="flex w-full justify-between items-start rounded-3xl absolute bottom-0">
              <img
                src="/02.svg"
                alt="Left Image"
                className="w-[55%] md:w-[60%] h-auto object-contain absolute bottom-0"
              />
              <img
                src="/Device2.svg"
                alt="Right Image"
                className="w-[40%] md:w-[39%] rounded-lg absolute -right-0 bottom-0"
              />
            </div>
          </div>
