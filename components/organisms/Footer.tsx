...
const Footer: React.FC = () => {
  return (
    <footer className="relative bg-[#8877D8] text-white py-24 mt-96 flex flex-col items-center">
      ...
      <motion.div
        className="bg-white shadow-lg border-2 border-[#8877D8] rounded-lg p-4 sm:p-6 md:p-8 w-[90%] sm:w-[80%] lg:w-[90%] absolute -top-80 sm:-top-48 transform flex flex-col md:flex-row items-center justify-center"
      ...
      >
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start">
          <h2 className="text-gray-800 text-lg sm:text-xl md:text-2xl font-bold mb-4 font-apfelregular">
          ...
          <textarea
            className="w-full h-20 sm:h-24 p-2 border border-gray-300 rounded-md mb-4 md:w-[80%] lg:w-[90%] font-euclidlight"
            placeholder="Tell us the features you’d love to see on Beauty Butler"
          />
          <div className="w-full flex justify-end mr-3">
            <button className="bg-[#8877D8] font-euclidmedium text-white px-6 sm:px-10 py-2 sm:py-3 rounded-xl">
              Submit
            </button>
          </div>
        </div>
